...
/**
 * Class that contains multiple helpers for developers...
 */
class corehelpers {

    /**
     * Detects a browser under runs the app in base on:
     *
     *      "op" => "(Opera)",
	 *		"ff" => "((Firebird)|(Firefox))",
	 *		"ga" => "(Galeon)",
    ...
    /**
     * Function that select the correct browser in the huge list of mobile devices!
     *
     * @param <bool> $iphone
     * @param <bool> $ipad
     * @param <bool> $android
     * @param <bool> $opera
     * @param <bool> $blackberry
     * @param <bool> $palm
     * @param <bool> $windows
     * @param <bool> $redirect
     * @param <bool> $desktopRedirect
     * @return <string>
     */
    public function detectbrowserisMobile($iphone = true, $ipad = true, $android = true , $opera = true, $blackberry = true, $palm = true, $windows = true, $redirect = false, $desktopRedirect = false) {
		$mobile = false;
